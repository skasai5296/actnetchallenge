...
python eval.py --resnet_shortcut A --feature_size 2048 --embedding_size 512 --lstm_memory 512 --bs 16 --batch_size 8 --langmethod Transformer --vocabpath vocab_pad.json \
