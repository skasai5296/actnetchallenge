...
--clip_len 64 --modelname resnext --modeldepth 101 --root_path /ssd2/dsets/activitynet_captions --meta_path videometa_val.json --mode val --n_classes 400 --submission_path submission_val3.json --model_ep 8
